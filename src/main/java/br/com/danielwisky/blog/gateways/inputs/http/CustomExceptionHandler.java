...
import br.com.danielwisky.blog.gateways.inputs.http.resources.response.ErrorResponse;
...
public class CustomExceptionHandler {
  ...
  public HttpEntity<ErrorResponse> handlerResourceNotFoundException(
    ...
    return new ResponseEntity<>(createMessage(ex), createHeaders(), NOT_FOUND);
  }
